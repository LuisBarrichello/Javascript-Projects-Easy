...
A metodologia aplicada é de ver os tutoriais, posteriormente em outro dia tentar construir o projeto específico visto antes de forma independente (o HTML, CSS, JavaScript) e depois voltando ao tutorial para fazer o que não consegui, corregindo erros e lendo documentações dos conceitos que não conheço.
